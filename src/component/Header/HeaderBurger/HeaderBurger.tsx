...
const HeaderBurger: FC<HeaderBurgerProps> = ({
  ...
  return (
    <div className="header-container-burger">
      <Button
        className={`burger-icon ${burgerActive ? "open" : ""}`}
        variant="contained"
        onClick={handleEventBurgerOpen}
      >
        <span></span>
        <span></span>
        <span></span>
      ...
      <div
        className={`burger-content ${burgerActive ? "open" : ""}`}
      ...
      >
        <div className="burger-content-Links">
          ...
          <NavLink className="burger-link" to="/news" onClick={handleLinkEvent}>
            News page
          </NavLink>
          <NavLink
            className="burger-link"
          ...
          >
            ...
            {shoppingCartLength.length >= 1 && (
              <span>{shoppingCartLength.length}</span>
            )}
          </NavLink>
        </div>
      </div>
