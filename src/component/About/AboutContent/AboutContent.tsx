            ...
            return (
                <motion.div className='about-content container'
                    ...
                    <div className="about-content-architecture-title">
                        <p className='nvidia-xl'>NVIDIA Ada Lovelace Architecture</p>
                    </div>
                    <div className="about-content-architecture-subtitle">
                        <p className='nvidia-3xl-bold'>Ahead of your time, become the best.</p>
                    </div>
                        ...
                        <div className="about-architecture-description">
                            <div className="about-architecture-description-item">
                                <div className="about-architecture-description-item-title">
                                    <p className='nvidia-2xl-bold'>New streaming multiprocessors</p>
                                </div>
                                <div className="about-architecture-description-item-subtitle">
                                    <p className='nvidia-p'>Up to 2x higher performance and energy efficiency</p>
                                </div>
                            </div>
                            <div className="about-architecture-description-item">
                                <div className="about-architecture-description-item-title">
                                    <p className='nvidia-2xl-bold'>Fourth generation tensor cores</p>
                                </div>
                                <div className="about-architecture-description-item-subtitle">
                                    <p className='nvidia-p'>Up to 4x faster performance with DLSS 3 compared to brute force rendering</p>
                                </div>
                            </div>
                            <div className="about-architecture-description-item">
                                <div className="about-architecture-description-item-title">
                                    <p className='nvidia-2xl-bold'>Third generation RT cores</p>
                                </div>
                                <div className="about-architecture-description-item-subtitle">
                                    <p className='nvidia-p'>Up to 2x faster performance with ray tracing</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='about-content full-screen'>
                    <motion.div className="about-content-performance container"
                        ...
                        <div className="about-content-performance-title">
                            <p className='nvidia-3xl-bold'>Performance</p>
                        </div>
                        ...
                        <div className="about-content-performance-subtitle">
                            <p className='nvidia-p-bold'>Relative performance</p>
                        </div>
            ...
            return (
                <motion.div className='about-content container'
                    ...
                    <div className="about-content-rtx-title">
                        <p className='nvidia-3xl-bold'>Popular games with RTX support</p>
                    </div>
                    <motion.ul
                        ...
                        <motion.li className="about-content-rtx-item" variants={item}>
                            ...
                            <div className="about-content-rtx-item-title">
                                <p className='nvidia-3xl-bold'>The Witcher 3: Wild Hunt. Complete edition</p>
                            </div>
                            ...
                            <div className="about-content-rtx-item-link">
                                <a href="https://www.youtube.com/watch?v=b3fWY-JGxt4&t=1s" target='_blank' className='nvidia-2xl-semibold'>
                                    Watch the video
                                    <Arrow/>
                                </a>
                            </div>
                        ...
                        <motion.li className="about-content-rtx-item" variants={item}>
                            ...
                            <div className="about-content-rtx-item-title">
                                <p className='nvidia-3xl-bold'>Cyberpunk 2077: Phantom Liberty</p>
                            </div>
                            <div className="about-content-rtx-item-description">
                                <p className='nvidia-p'>
                            ...
                            <div className="about-content-rtx-item-link">
                                <a href="https://www.youtube.com/watch?v=hKfo__zgjto" target='_blank' className='nvidia-2xl-semibold'>
                                    Watch the video
                                    <Arrow/>
                                </a>
                            </div>
                        ...
                        <motion.li className="about-content-rtx-item" variants={item}>
                            ...
                            <div className="about-content-rtx-item-title">
                                <p className='nvidia-3xl-bold'>Alan Wake 2</p>
                            </div>
                            <div className="about-content-rtx-item-description">
                                <p className='nvidia-p'>
                            ...
                            <div className="about-content-rtx-item-link">
                                <a href="https://www.youtube.com/watch?v=f6frfhR_0Qk" target='_blank' className='nvidia-2xl-semibold'>
                                    Watch the video
                                    <Arrow/>
                                </a>
                            </div>
                        ...
                        <motion.li className="about-content-rtx-item" variants={item}>
                            ...
                            <div className="about-content-rtx-item-title">
                                <p className='nvidia-3xl-bold'>Diablo IV</p>
                            </div>
                            <div className="about-content-rtx-item-description">
                                <p className='nvidia-p'>
                            ...
                            <div className="about-content-rtx-item-link">
                                <a href="https://www.youtube.com/watch?v=fGdnys7CKHY" target='_blank' className='nvidia-2xl-semibold'>
                                    Watch the video
                                    <Arrow/>
                                </a>
                            </div>
                ...
                <div className='about-content dlss'>
                    ...
                    <motion.div className="about-content-dlss container"
                        ...
                        <div className="about-content-dlss-subtitle">
                            <p className='nvidia-xl-bold'>NVIDIA DLSS 3</p>
                        </div>
                        <div className="about-content-dlss-title">
                            <p className='nvidia-3xl-bold'>Maximum FPS and quality using AI</p>
                        </div>
                ...
                <div className='about-content reflex'>
                    ...
                    <motion.div className="about-content-reflex container"
                        ...
                        <div className="about-content-reflex-subtitle">
                            <p className='nvidia-xl-bold'>NVIDIA Reflex</p>
                        </div>
                        <div className="about-content-reflex-title">
                            <p className='nvidia-3xl-bold'>Milliseconds determine victory.</p>
                        </div>
